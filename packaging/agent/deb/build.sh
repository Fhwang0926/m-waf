...
MWAF_AGENT_DEB_TARGETS=${MWAF_AGENT_DEB_TARGETS:-ubuntu:18.04 ubuntu:20.04 ubuntu:22.04 ubuntu:24.04 ubuntu:26.04 debian:12}
...
installed_size=$(du -sk "$root/usr" "$root/lib" | awk '{total += $1} END {print total + 0}')
